  ...
  group('OAuthProviderButton', () {
    ...
    testWidgets('applies background color from style', (tester) async {
      ...
      final containerFinder = find.byWidgetPredicate((widget) {
        return widget is Material && widget.color!.r == expectedColor.r && widget.color!.g == expectedColor.g && widget.color!.b == expectedColor.b;
      });
    ...
    testWidgets('applies text color from style', (tester) async {
      ...
      final textFinder = find.byWidgetPredicate(
        (widget) =>
            widget is Text &&
            widget.style!.color!.r ==
                style.color.getValue(Brightness.dark).r && widget.style!.color!.g == style.color.getValue(Brightness.dark).g && widget.style!.color!.b == style.color.getValue(Brightness.dark).b,
      );
